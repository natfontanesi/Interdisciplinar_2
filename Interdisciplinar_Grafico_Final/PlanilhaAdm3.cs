...
{
    public partial class PlanilhaAdm3 : Form
    {
        ...
        private void PlanilhaAdm3_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string strSelect = "SELECT * FROM professor";
                ...
                gvAdmProf.DataSource = data_table;

                //oculta a coluna de chave primaria
                gvAdmProf.Columns["codigop"].Visible = false;
        ...
        private void btnRemover_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow item in gvAdmProf.SelectedRows)
            {
                if (!item.IsNewRow)
                {
                    gvAdmProf.Rows.RemoveAt(item.Index);
                }
        ...
        private void PlanilhaAdm3_FormClosing(object sender, FormClosingEventArgs e)
        {
