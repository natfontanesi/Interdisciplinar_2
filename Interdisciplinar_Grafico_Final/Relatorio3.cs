...
{
    public partial class Relatorio3 : Form
    {
        ...
        private void Relatorio3_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string strSelect = "SELECT t.inicio,t.termino, c.nome, a.nome FROM curso c, turma t, aluno a WHERE t.curso = c.codigocur";
        ...
        private void Relatorio3_FormClosing(object sender, FormClosingEventArgs e)
        {
