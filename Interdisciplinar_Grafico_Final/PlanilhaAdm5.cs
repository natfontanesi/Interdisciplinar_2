...
{
    public partial class PlanilhaAdm5 : Form
    {
        ...
        private void PlanilhaAdm5_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string strSelect = "SELECT * FROM curso";
                ...
                gbAdmCur.DataSource = data_table;

                //oculta a coluna de chave primaria
                gbAdmCur.Columns["codigocur"].Visible = false;
        ...
        private void gbAdmCur_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void btnRemover_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow item in gbAdmCur.SelectedRows)
            {
                if (!item.IsNewRow)
                {
                    gbAdmCur.Rows.RemoveAt(item.Index);
                }

            }
        }

        private void PlanilhaAdm5_FormClosing(object sender, FormClosingEventArgs e)
        {
