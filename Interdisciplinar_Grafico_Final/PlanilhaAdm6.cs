...
{
    public partial class PlanilhaAdm6 : Form
    {
        ...
        private void PlanilhaAdm6_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string strSelect = "SELECT * FROM turma";
                ...
                gvAdmTur.DataSource = data_table;

                //oculta a coluna de chave primaria
                gvAdmTur.Columns["codigot"].Visible = false;
        ...
        private void btnRemover_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow item in gvAdmTur.SelectedRows)
            {
                if (!item.IsNewRow)
                {
                    gvAdmTur.Rows.RemoveAt(item.Index);
                }

            }
        }

        private void PlanilhaAdm6_FormClosing(object sender, FormClosingEventArgs e)
        {
